...
#[derive(Debug)]
pub struct CryptoRelayProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoRelayProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoRelay processing");
    
    let mut processor = CryptoRelayProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoRelayProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoRelayProcessor::new(false);
